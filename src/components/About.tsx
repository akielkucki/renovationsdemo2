        ...
        <div className="grid lg:grid-cols-2 gap-16 lg:gap-24 items-center">
          ...
          >
            ...
            <div className="relative aspect-[4/5] bg-surface border border-border overflow-hidden">
              ...
              {/* Decorative shapes */}
              <div className="absolute top-12 left-12 w-24 h-24 border border-foreground/10" />
              <div className="absolute top-16 left-16 w-24 h-24 border border-foreground/5" />

              {/* Large number */}
              <div className="absolute bottom-12 right-12 font-[family-name:var(--font-space-grotesk)] text-[200px] font-bold leading-none text-foreground/5">
              ...
              <div className="absolute inset-0 flex items-center justify-center">
                <div className="text-center">
                  <div className="font-[family-name:var(--font-space-grotesk)] text-8xl md:text-9xl font-bold text-foreground/10">
            ...
            <motion.div
              ...
              className="absolute -bottom-8 -left-8 bg-foreground text-background p-8"
            >
