            ...
            >
              {Object.entries(siteConfig.social).map(([platform, url]) => (
                <a
                  ...
                  className="w-12 h-12 bg-surface border border-border flex items-center justify-center text-muted hover:text-foreground hover:border-foreground/30 transition-all duration-300"
                  aria-label={platform}
                >
                  {platform === "instagram" && (
              ...
              <div className="space-y-6">
                <div className="grid md:grid-cols-2 gap-6">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-4 py-3 bg-background border border-border text-foreground font-[family-name:var(--font-inter)] placeholder:text-muted/50 focus:outline-none focus:border-foreground/50 transition-colors"
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  ...
                  <div>
                    ...
                    <select
                      ...
                      className="w-full px-4 py-3 bg-background border border-border text-foreground font-[family-name:var(--font-inter)] focus:outline-none focus:border-foreground/50 transition-colors appearance-none cursor-pointer"
                    >
                ...
                <div>
                  ...
                  <textarea
                    ...
                    className="w-full px-4 py-3 bg-background border border-border text-foreground font-[family-name:var(--font-inter)] placeholder:text-muted/50 focus:outline-none focus:border-foreground/50 transition-colors resize-none"
