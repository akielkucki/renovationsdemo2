  ...
  return (
      ...
      >
        ...
        >
          {["Beautiful", "lies", "below"].map((word, i) => (
              <motion.span
                  ...
                  className="text-[10px] uppercase tracking-[0.4em] text-muted font-light"
              >
                {word}
              </motion.span>
          ))}
        ...
        <motion.div
            ...
            className="relative w-[1px] overflow-hidden bg-border/30"
        >
          <motion.div
              animate={{ top: ["-100%", "100%"] }}
              transition={{
              ...
              className=" h-full bg-gradient-to-b from-transparent via-muted to-transparent opacity-70"
          />
        </motion.div>
      </motion.div>
  );
  ...
  return (
    <section className="relative min-h-screen flex flex-col w-full items-center justify-center overflow-hidden bg-background">
      ...
      <motion.div
        ...
        className="absolute bottom-1/4 left-1/4 w-[500px] h-[500px] bg-foreground/5 rounded-full blur-3xl"
      />
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-8 py-32">
        <div className="flex flex-col items-center text-center">
          ...
          <motion.div
            ...
            className="mt-20 flex justify-center gap-16 w-md"
          >
