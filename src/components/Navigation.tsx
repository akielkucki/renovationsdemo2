            ...
            <div className="hidden md:flex items-center gap-8">
              {siteConfig.navigation.map((item) => (
                <a
                  key={item.label}
                  href={item.href}
                  className="relative font-[family-name:var(--font-inter)] text-sm font-medium text-accent-muted hover:text-foreground transition-colors duration-300 group"
                >
                  {item.label}
              ...
              <a
                href="#contact"
                className="ml-4 px-6 py-2.5 bg-foreground text-background font-[family-name:var(--font-inter)] text-sm font-semibold tracking-wide hover:bg-accent-muted transition-colors duration-300"
              >
                Get Quote
              </a>
            </div>
          ...
          >
            <div className="flex flex-col items-center justify-center h-full gap-8">
              ...
              <motion.a
                ...
                className="mt-4 px-8 py-3 bg-foreground text-background font-[family-name:var(--font-inter)] text-lg font-semibold"
              >
                Get Quote
              </motion.a>
            </div>
